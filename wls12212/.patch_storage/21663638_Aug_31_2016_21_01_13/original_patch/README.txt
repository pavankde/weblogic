===============================
Interim Patch for Bug: 21663638
===============================
...
This patch has been marked as eligible for Zero Downtime Patching. The type
of Zero Downtime Patching supported by this patch is FMW_ROLLING_ORACLE_HOME.
...
2. Oracle recommends that all customers be on the latest version of OPatch for
   ...
   "Note 1587524.1 Using OUI NextGen OPatch 13 for Oracle Fusion Middleware 12c".
...
3. Verify the OUI Inventory.
   ...
   Note: This needs the ORACLE_HOME to be set(refer section "3. Pre-Installation Instructions") 
...
1. Set the environment variable ORACLE_HOME to your product installed directory.
...
1. Unzip the patch zip file into the PATCH_TOP.
   ...
   $ unzip -d PATCH_TOP p21663638_122100_Generic.zip
...
  
         For example: To unzip using 7-zip, run the command: 
                      "c:\Program Files\7-Zip\7z.exe" x  p21663638_122100_Generic.zip

2. Set your current directory to the directory where the patch is located.

   $ cd PATCH_TOP/21663638
...
If a merge of the new patch (XXXX) and the conflicting patch(es) ( YYYY) is required,
contact Oracle Support Services and request a Merged patch.

Do you want to proceed? [y|n]
n

You must stop the patch installation and contact Oracle Support to determine how to proceed.
...
21663638 - FUSION APPS FUNCTIONALITY FAILURE DUE TO TYPE MISMATCH IN ENQUEUE/DEQUEUE MESSAG
