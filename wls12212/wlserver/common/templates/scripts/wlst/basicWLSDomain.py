...
readTemplate("L:\sw\java\servers\wls12212\wlserver/common/templates/wls/wls.jar")
...
writeDomain('L:\sw\java\servers\wls12212/user_projects/domains/basicWLSDomain')
closeTemplate()
