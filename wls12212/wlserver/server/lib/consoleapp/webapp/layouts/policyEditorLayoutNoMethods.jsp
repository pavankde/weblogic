...
<div class="contenttable">
    ...
    <div class="upperButtonBar">
      <wl:button-bar>
        <wl:button-bar-button labelid="button.save" action="/persist" singlechange="false"/>
      </wl:button-bar>
    </div>
    ...
    <fieldset class="formseparator">
     ...
     <wl:policy-editor name="policyEditorForm" labelId="core.server.serverpolicies.conditions" />
     <template:includeSection name="buttonBar"/>
    ...
    <wl:policy-editor name="policyEditorForm" displayInheritedPolicy="true" labelId="core.server.serverpolicies.conditions" />
